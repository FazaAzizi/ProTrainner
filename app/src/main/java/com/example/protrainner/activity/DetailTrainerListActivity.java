...
public class DetailTrainerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_trainer_list);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DetailTrainerListActivity.this, TrainerListActivity.class);
