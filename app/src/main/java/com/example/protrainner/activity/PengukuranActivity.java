...
public class PengukuranActivity extends AppCompatActivity implements  ListPengukuranAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tmbh = findViewById(R.id.tambah_memberpengukuran);
        ...
        tmbh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                c.putString("id",id);
                Intent intent = new Intent(PengukuranActivity.this, PengukuranInputActivity.class);
                intent.putExtras(c);
    ...
    private void setUpRecyclerView() {
        ...
        adapter.setOnItemClickListener(new ListPengukuranAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot dS, int position) {
                ...
                Intent intent = new Intent(PengukuranActivity.this, PengukuranDetailActivity.class);
                intent.putExtras(b);
                startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        c.putString("nama",nama);
        c.putString("id",id);
        Intent intent = new Intent(PengukuranActivity.this, DetailMemberList2Activity.class);
        intent.putExtras(c);
        startActivity(intent);
    }
}